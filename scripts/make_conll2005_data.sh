...
SRL_PATH="./data/conll2005"

if [ ! -d $SRL_PATH ]; then
  mkdir -p $SRL_PATH
fi

wget -O "${SRL_PATH}/srlconll-1.1.tgz" https://www.cs.upc.edu/~srlconll/srlconll-1.1.tgz
...
do
  echo $s
  cat ${WSJPATH}/combined/wsj/$s/* | wsj-removetraces.pl | wsj-to-se.pl -w 1 | awk '{print $1}' | \
...
python ./scripts/conll05_to_json.py "${CONLL05_PATH}/train-set"   "${SRL_PATH}/train.english.conll05.jsonlines" 5
python ./scripts/conll05_to_json.py "${CONLL05_PATH}/dev-set"   "${SRL_PATH}/dev.english.conll05.jsonlines" 5
python ./scripts/conll05_to_json.py "${CONLL05_PATH}/test-wsj"   "${SRL_PATH}/test_wsj.english.conll05.jsonlines" 1
python ./scripts/conll05_to_json.py "${CONLL05_PATH}/test-brown"   "${SRL_PATH}/test_brown.english.conll05.jsonlines" 1

python ./scripts/preprocess.py  "${SRL_PATH}/train.english.conll05.jsonlines"  "${SRL_PATH}/train.english.conll05.json" 
python ./scripts/preprocess.py  "${SRL_PATH}/dev.english.conll05.jsonlines"  "${SRL_PATH}/dev.english.conll05.json"
python ./scripts/preprocess.py  "${SRL_PATH}/test_wsj.english.conll05.jsonlines"  "${SRL_PATH}/test_wsj.english.conll05.json"
python ./scripts/preprocess.py  "${SRL_PATH}/test_brown.english.conll05.jsonlines"  "${SRL_PATH}/test_brown.english.conll05.json"
